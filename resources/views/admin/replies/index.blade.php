...
@section('content')
    ...
    @if( count($comment->replies) )
        <div class="card my-5 text-dark border border-secondary">
                    ...
                    <div class="row align-items-center my-2">
                        ...
                        <div class="col-3">
                            ...
                            <div class="d-flex">
                                ...
                                <a href="{{ route('reply.approve',$reply->id) }}" class="<?php echo ($reply->approve) ? 'btn btn-info' : 'btn btn-warning' ;?> mr-2">
                                
                                    {{ ($reply->approve) ? 'Disapprove' : 'Approve' }}

                                </a>
                                <form action="{{ route('reply.destroy',[$comment->id,$reply->id]) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
